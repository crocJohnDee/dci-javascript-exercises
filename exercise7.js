...
console.log("1: " + string.substr(18, 4));
...
console.log("2: " + hobby[1] + hobby[4] + hobby[5])
...
console.log("3: " + greet.toUpperCase());
...
console.log("4: " + greet2.toLowerCase());
...
let noHobby = "cooking";
console.log("8: " + noHobby.toUpperCase().includes("Java"));
...
console.log("9: " + hobby[9] + hobby.substr(1, 8) + hobby[0]);
